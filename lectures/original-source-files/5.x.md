-   [5.1 Course Recap](#course-recap)
    -   [5.1.1 - Introduction](#introduction)
    -   [5.1.2 - Recap: HCI Principles](#recap-hci-principles)
    -   [5.1.3 - Recap: Feedback Cycle](#recap-feedback-cycle)
    -   [5.1.4 - Recap: Direct Manipulation and Invisible
        Interfaces](#recap-direct-manipulation-and-invisible-interfaces)
    -   [5.1.5 - Recap: Human Abilities](#recap-human-abilities)
    -   [5.1.6 - Recap: Design Principles and
        Heuristics](#recap-design-principles-and-heuristics)
    -   [5.1.7 - Recap: Mental Models and
        Representations](#recap-mental-models-and-representations)
    -   [5.1.8 - Recap: Task Analysis](#recap-task-analysis)
    -   [5.1.9 - Recap Distributed
        Cognition](#recap-distributed-cognition)
    -   [5.1.10 - Recap: HCI Methods](#recap-hci-methods)
    -   [5.1.11 - Recap: Ethics and Human
        Research](#recap-ethics-and-human-research)
    -   [5.1.12 - Recap: Needfinding and Requirements
        Gathering](#recap-needfinding-and-requirements-gathering)
    -   [5.1.13 - Recap: Design
        Alternatives](#recap-design-alternatives)
    -   [5.1.14 - Recap: Prototyping](#recap-prototyping)
    -   [5.1.15 - Recap: Evaluation](#recap-evaluation)
    -   [5.1.16 - Recap: HCI and Agile
        Development](#recap-hci-and-agile-development)
    -   [5.1.17 - Exploring HCI: Recap](#exploring-hci-recap)
    -   [5.1.18 - Conclusion](#conclusion)
-   [5.2 Related Fields](#related-fields)
    -   [5.2.1 - Introduction](#introduction-1)
    -   [5.2.2 - Human Factors and Industrial
        Design](#human-factors-and-industrial-design)
    -   [5.2.3 - User Interface Design](#user-interface-design)
    -   [5.2.4 - User Experience Design](#user-experience-design)
    -   [5.2.5 - HCI & Psychology](#hci-psychology)
    -   [5.2.6 - Human-Centered Computing](#human-centered-computing)
    -   [5.2.7 - Cognitive Science](#cognitive-science)
    -   [5.2.8 - Computer-Supported
        Collaboration](#computer-supported-collaboration)
    -   [5.2.9 - Intelligent User
        Interfaces](#intelligent-user-interfaces)
    -   [5.2.10 - Conclusion](#conclusion-1)
-   [5.3 Next Steps](#next-steps)
    -   [5.3.1 - Introduction](#introduction-2)
    -   [5.3.2 - Ongoing Research](#ongoing-research)
    -   [5.3.3 - MOOCs](#moocs)
    -   [5.3.4 - MSCS-HCI](#mscs-hci)
    -   [5.3.5 - MS-HCI](#ms-hci)
    -   [5.3.6 - PhD-HCI](#phd-hci)
    -   [5.3.7 - PhD-HCC](#phd-hcc)
    -   [5.3.8 - Thank you - and good luck](#thank-you---and-good-luck)
...
The first stage of the design life cycle was need-finding. Need-finding
...
courses. So generally speaking, while in HCI we've taken special care to
...
human-computer interaction, and intelligent user interfaces, we'll put
