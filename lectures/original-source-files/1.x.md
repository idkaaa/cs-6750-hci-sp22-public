-   [1.1 Introduction to HCI](#introduction-to-hci)
    -   [1.1.1 - Humans](#humans)
    -   [1.1.2 - Computers](#computers)
    -   [1.1.3 - Interaction](#interaction)
    -   [1.1.4 - Reflections: Interacting & Interfaces
        Question](#reflections-interacting-interfaces-question)
    -   [1.1.4 - Reflections: Interacting & Interfaces
        Solution](#reflections-interacting-interfaces-solution)
    -   [1.1.5 - The HCI Space](#the-hci-space)
    -   [1.1.6 - HCI in the Big Picture](#hci-in-the-big-picture)
    -   [1.1.7 - HCI vs. Human Factors](#hci-vs.-human-factors)
    -   [1.1.8 - HCI vs. User Interface
        Design](#hci-vs.-user-interface-design)
    -   [1.1.9 - HCI vs. User Experience
        Design](#hci-vs.-user-experience-design)
    -   [1.1.10 - HCI vs. Psychology](#hci-vs.-psychology)
    -   [1.1.11 - HCI: Research and Design](#hci-research-and-design)
    -   [1.1.12 - Welcome to HCI](#welcome-to-hci)
-   [1.2 - Introduction to CS6750](#introduction-to-cs6750)
    -   [1.2.1 - Introduction to CS6750](#introduction-to-cs6750-1)
    -   [1.2.2 - Learning Goals](#learning-goals)
    -   [1.2.3 - Learning Outcomes: To
        Design](#learning-outcomes-to-design)
    -   [1.2.4 - Learning Outcomes:
        Effectiveness](#learning-outcomes-effectiveness)
    -   [1.2.5 - Learning Outcomes: Between Humans and
        Computer](#learning-outcomes-between-humans-and-computer)
    -   [1.2.6 - Learning Strategies: Video
        Material](#learning-strategies-video-material)
    -   [1.2.7 - Learning Strategies: Georgia
        Tech](#learning-strategies-georgia-tech)
    -   [1.2.8 - Learning Assessments](#learning-assessments)
    -   [1.2.9 - Course Structure](#course-structure)
    -   [1.2.10 - 5 Tips For Doing Well in
        CS6750](#tips-for-doing-well-in-cs6750)
    -   [1.2.11 - Conclusion](#conclusion)
-   [1.3 Exploring HCI](#exploring-hci)
    -   [1.3.1 - Introduction to Exploring
        HCI](#introduction-to-exploring-hci)
    -   [1.3.2 - Technology: Virtual
        Reality](#technology-virtual-reality)
    -   [1.3.3 - Technology: Augmented
        Reality](#technology-augmented-reality)
    -   [1.3.4 - Technology: UbiComp and
        Wearables](#technology-ubicomp-and-wearables)
    -   [1.3.5 - Technology: Robotics](#technology-robotics)
    -   [1.3.6 - Technology: Mobile](#technology-mobile)
    -   [1.3.7 - Idea: Context-Sensitive
        Computing](#idea-context-sensitive-computing)
    -   [1.3.8 - Idea: Gesture-Based
        Interaction](#idea-gesture-based-interaction)
    -   [1.3.9 - Idea: Pen- and Touch-Based
        Interaction](#idea-pen--and-touch-based-interaction)
    -   [1.3.10 - Idea: Information
        Visualization](#idea-information-visualization)
    -   [1.3.11 - Idea: CSCW](#idea-cscw)
    -   [1.3.12 - Idea: Social Computing](#idea-social-computing)
    -   [1.3.13 - Domain: Special Needs](#domain-special-needs)
    -   [1.3.14 - Domain: Education](#domain-education)
    -   [1.3.15 - Domain: Healthcare](#domain-healthcare)
    -   [1.3.16 - Domain: Security](#domain-security)
    -   [1.3.17 - Domain: Games](#domain-games)
    -   [1.3.18 - Reflections: Exploring
        HCI](#reflections-exploring-hci)
    -   [1.3.19 - Conclusion to Exploring
        HCI](#conclusion-to-exploring-hci)
